#!/bin/bash
# Check what team_id the TeamLeader and workers resolve to
echo "=== TeamLeader _get_team_id ==="
...
print('global_shared_remote:', sync._get_global_shared_remote())
" 2>&1

echo ""
echo "=== lead-intake _get_team_id ==="
